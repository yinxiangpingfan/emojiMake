    ...
    <div class="login-container">
      <div class="login-box">
        <div class="login-header">
          ...
          <p class="login-subtitle">登录到AI视频趣味表情生成</p>
        </div>
    ...
    if (valid) {
      ...
      try {
        ...
        if (response.data.code === 0) {
          ...
          userStore.login(token, { phone: loginForm.phone })
          ...
          const phoneAbbreviation = loginForm.phone.slice(-4);
          
          ElNotification({
            title: `${greeting}，用户${phoneAbbreviation}`,
            message: '开始生成有趣的表情包吧！',
            type: 'success',
            duration: 5000,
            offset: 50
